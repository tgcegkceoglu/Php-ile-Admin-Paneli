                    ...
                    <div class="col mr-2">
                        ...
                        <form class="user" action="netting/islem.php" method="POST">
                            <div class="form-group">
                                <label class="text-sm font-weight-bold text-primary">Alt Kategori Adı</label>
                            ...
                            <div class="form-group">
                                 ...
                                 <div>
                                    <select id="heard" class="form-control" name="category_name">
                                        <?php 
                                        $kategoriadsor = $db->prepare("SELECT * FROM menu");
                                        $kategoriadsor->execute();
                                        while($kategoriadcek = $kategoriadsor->fetch(PDO::FETCH_ASSOC)){ ?>
                                          <option value="<?php echo $kategoriadcek['menu_ad'] ?>"><?php echo $kategoriadcek['menu_ad'] ?></option>
                                      <?php } ?>  
                                    </select>
                                </div>
                            </div>
