                    ...
                    <div class="col mr-2">
                        ...
                        <form class="user" action="netting/islem.php" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-user font-weight-bold" value="<?= $kategoricek['kategori_ad'] ?>" name="kategori_ad" id="kategori_ad" placeholder="Ad">
                            </div>
                            
                            <div class="form-group">
                                <label class="text-sm font-weight-bold text-primary">Sıra</label>
                                <input type="text" class="form-control form-user font-weight-bold" value="<?= $kategoricek['kategori_sira'] ?>" name="kategori_sira" id="kategori_sira" placeholder="Sıra">
                            </div>
                            <div class="form-group">
                                 ...
                                 <div>
                                    <select id="heard" class="form-control" name="kategori_ust">
                                        ...
                                        while($menucek = $menusor->fetch(PDO::FETCH_ASSOC)){ ?>
                                           <option value="<?php echo $menucek['menu_id'] ?>" <?php echo $menucek['menu_id'] == $kategoricek['kategori_ust']  ? 'selected=""' : ''; ?>><?php echo $menucek['menu_ad'] ?></option>
                                      <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <button class="btn btn-primary float-right" type="submit" name="kategoriduzenle" type="submit">Güncelle</button>
                            </div>
